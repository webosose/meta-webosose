...
# drop github-releases as it isn't in kirkstone and only sets
# UPSTREAM_CHECK_URI, UPSTREAM_CHECK_REGEX which we don't need in backports
inherit manpages systemd update-rc.d
