...
# RUST_LIBC was removed in:
# https://git.openembedded.org/openembedded-core/commit/?h=langdale&id=f35d5af06db10fa20e55f4c738e665b35f5c394b
# and these backported recipes don't need it, but this overlayed bbclass
# causes the original rust-crosssdk recipe in kirkstone to fail parsing
# (even with it's not going to be used in the end, because 1.63.0 version
# from this layer will be preferred)
# oe-core/meta/recipes-devtools/rust/rust-crosssdk_1.59.0.bb: QA Issue: PN: rust-crosssdk-core2-64-${RUST_LIBC} is upper case, this can result in unexpected behavior. [uppercase-pn]
RUST_LIBC = "${TCLIBC}"
