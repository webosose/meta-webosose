...
# a969efd rpi-config: Check for armstub based on machine feature
# 290c152 rpi-config: Check some config values against "1"
# 33f810f rpi-config: Handle ARMSTUB
# 6305aa7 rpi-config: used printf to escape properly
# 12e61fa Add Pican2 support
