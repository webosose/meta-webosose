...
do_webos_deploy_fixup:prepend() {
    ...
    [ -e       ${DEPLOY_DIR_IMAGE}/${IMAGE_NAME}.wic.vmdk ] && \
        ln -vf ${DEPLOY_DIR_IMAGE}/${IMAGE_NAME}.wic.vmdk \
               ${DEPLOY_DIR_IMAGE}/${IMAGE_LINK_NAME}.wic.vmdk

    [ -e       ${DEPLOY_DIR_IMAGE}/${IMAGE_NAME}.wic.vmdk.gz ] && \
        ln -vf ${DEPLOY_DIR_IMAGE}/${IMAGE_NAME}.wic.vmdk.gz \
