...
SNOWBOY_ARCH_armv6 = "rpi"
SNOWBOY_ARCH_armv7a = "rpi"
SNOWBOY_ARCH_armv7ve = "rpi"
SNOWBOY_ARCH_aarch64 = "aarch64-ubuntu1604"
SNOWBOY_ARCH_x86-64 = "ubuntu64"

FILESEXTRAPATHS_prepend := "${THISDIR}/${BPN}:"
SRC_URI_append = " file://CMakeLists.txt;subdir=git"
...
SNOWBOY_EXTRA_FLAGS_aarch64 = "-std=c++11"

EXTRA_OECMAKE_append = " -DBUILD_SHARED_LIB=OFF -DINSTALL_KEYWORD_MODELS=ON -DSNOWBOY_ARCH='${SNOWBOY_ARCH}' -DSNOWBOY_EXTRA_FLAGS='${SNOWBOY_EXTRA_FLAGS}'"

FILES_${PN}-dev += "${libdir}/snowboy/*.so"
...
PACKAGES =+ "${PN}-models"
FILES_${PN}-models = "${sysconfdir}/snowboy/models/*"
